...
output "transit_subnets_ipv6_cidr_blocks" {
  description = "List of IPv6 cidr_blocks of transit subnets in an IPv6 enabled VPC"
  value       = compact(aws_subnet.transit[*].ipv6_cidr_block)
}
...
output "appliance_route_table_ids" {
  description = "List of IDs of public route tables"
  value       = aws_route_table.appliance[*].id
}
...
output "transit_network_acl_id" {
  description = "ID of the transit network ACL"
  value       = try(aws_network_acl.transit[0].id, "")
}

output "transit_network_acl_arn" {
  description = "ARN of the transit network ACL"
  value       = try(aws_network_acl.transit[0].arn, "")
}
